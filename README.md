...
The Harmonic System is a new way to think about music theory. By replacing traditional note names with numbers that reflect harmonic relationships, it makes understanding harmony significantly easier. It can be seen as a more intuitive and consistent alternative to Roman-Numeral Analysis.
...
As an example, consider the C-major scale: C, D, E, F, G, A and B. The harmonic labels of these notes are $4, 6, 8, 3, 5, 7, 9$ respectively. Sorting these, gives $3, 4, 5, 6, 7, 8, 9$ - just $7$ **consecutive numbers** from $3$ to $9$.
The pattern of whole and half steps is just a side effect of picking seven consecutive harmonic labels. 

Similarly, any other major scale also consists of $7$ consecutive harmonic labels on the clock (wrapping from 11 back to 0). The root note of the scale is the second-lowest number in this sequence.
...
- A similar concept is the _camelot wheel_ for DJing
