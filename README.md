...
As an example, consider the C-major scale: C, D, E, F, G, A and B. Their harmonic labels are $4, 6, 8, 3, 5, 7, 9$ respectively. Sorting these, gives $3, 4, 5, 6, 7, 8, 9$ - just $7$ **consecutive numbers** from $3$ to $9$! The pattern of whole and half steps is just a side effect of picking seven consecutive harmonic labels. 
